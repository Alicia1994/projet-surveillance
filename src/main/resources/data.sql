/*INSERT into users (username, password, email, role, dateAccount) values ('user', 'user1234', 'user@mail.com', 'USER');
INSERT into users (username, password, email, role) values ('admin', 'admin1234', 'admin@mail.com', 'ADMIN');*/
